...
|---|---|---|---|
| R01 | Run full implementation for the 6872 baseline | done | Reports copied; result is `7063 LUT / WNS -10.360 ns`, timing failed |
| R02 | Reduce MEM/DCache-to-PC control fan-in | P0 | New variant improves WNS or reduces failing endpoints without dropping below CoreMark 5 |
