...
| 地址范围 | 设备 | 说明 |
|----------|------|------|
| 0x0000_0000 ~ 0x0000_3FFF | ROM (16KB) | 指令存储器 |
| 0x0000_4000 ~ 0x0000_7FFF | RAM (16KB) | 数据存储器 |
| 0x1000_0000 | UART_TX | 串口发送寄存器 |
| 0x1000_0004 | DONE | 完成标志寄存器 |
| 0x1000_0008 | TIMER_VALUE_LO | 定时器低32位 |
| 0x1000_000C | TIMER_VALUE_HI | 定时器高32位 |
| 0x1000_0010 | TIMER_CMP_LO | 定时器比较值低32位 |
| 0x1000_0014 | TIMER_CMP_HI | 定时器比较值高32位 |
| 0x1000_0018 | TIMER_CTRL | 定时器控制寄存器 |
