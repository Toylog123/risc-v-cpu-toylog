...
- Current lower-area 5+ candidate:
  - commit: `tag target`
  - tag: `freeze-strict-dcache512-rc64-nonext-8201lut-coremark5p07-20260528`
  - LUT: `8201`
...
- Lower-area candidate configuration:
  `DCache512 + RC64 + branchfold + NT-load fold + no branchfold next-cache + no dynamic BHT + no ZBKB + DCache tag trim + redirect-cache tag-width trim`
- Evidence:
