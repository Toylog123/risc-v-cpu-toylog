...
module YH_rv_cpu_strict50_perf_demo_tb #(
    ...
    parameter integer MAX_CYCLES = 100000000
) ();
...
always @(posedge clk) begin
    if (rst_n) begin
        ...
        if (done) begin
            if (pass_idx >= PASS_LEN) begin
                $display("\nPASS: strict50 perf demo completed at PC=%h in %0d cycles, UART bytes=%0d", debug_pc, cycle, uart_count);
                $finish;
            end
