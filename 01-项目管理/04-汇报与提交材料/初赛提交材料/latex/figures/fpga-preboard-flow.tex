\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=9mm and 9mm, every node/.style={font=\small}]
        \node[reportbox, minimum width=27mm] (rtl) {RTL / 脚本\\\scriptsize 主线工程输入};
        ...
        \node[reportbox, fill=orange!10, minimum width=33mm, below=16mm of rpt] (closure) {pre-board closure\\\scriptsize 当前已完成状态};
