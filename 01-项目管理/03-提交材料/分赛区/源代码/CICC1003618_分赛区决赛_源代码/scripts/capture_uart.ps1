...
try {
    ...
    Write-Host "Program the FPGA bitstream or press board reset now to capture the boot banner."
...
if ($text.Length -eq 0) {
    ...
    Write-Host "For PYNQ-Z2 Method A, PL UART TX is Pmod B JB1/Y14 and needs an external 3.3 V USB-UART adapter."
}
