...
# File role: fpga/vivado/scripts/report_hier_util_from_dcp.tcl is part of the FPGA prototype build, constraint or board adaptation source.
...
# File: fpga/vivado/scripts/report_hier_util_from_dcp.tcl
