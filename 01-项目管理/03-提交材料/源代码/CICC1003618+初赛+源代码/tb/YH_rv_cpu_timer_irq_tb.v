...
// File role: tb/YH_rv_cpu_timer_irq_tb.v is part of the simulation testbench and benchmark verification source.
...
// File: tb/YH_rv_cpu_timer_irq_tb.v
...
module YH_rv_cpu_timer_irq_tb;

localparam string ROM_HEX = "build/sw/YH_rv_cpu_timer_irq_smoke.hex";
