...
@REM File role: scripts/run_memwait_overlap_diag.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/run_memwait_overlap_diag.bat
