...
@REM File role: scripts/run_fetch_prefetch_diag.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/run_fetch_prefetch_diag.bat
