...
@REM File role: scripts/prepare_xsim_runtime.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/prepare_xsim_runtime.bat
