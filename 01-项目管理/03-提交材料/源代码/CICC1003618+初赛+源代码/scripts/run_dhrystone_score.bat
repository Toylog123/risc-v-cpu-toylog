...
@REM File role: scripts/run_dhrystone_score.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/run_dhrystone_score.bat
