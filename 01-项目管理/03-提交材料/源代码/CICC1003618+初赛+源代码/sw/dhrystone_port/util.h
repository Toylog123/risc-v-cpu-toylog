...
// File role: sw/dhrystone_port/util.h is part of the RISC-V software, benchmark port, startup or linker source.
...
#ifndef YH_DHRYSTONE_UTIL_H
#define YH_DHRYSTONE_UTIL_H
