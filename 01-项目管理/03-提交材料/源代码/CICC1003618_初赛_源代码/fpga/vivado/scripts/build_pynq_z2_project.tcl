...
set debug_led_mode 0
set debug_uart_diag_mode 0
...
if {[info exists ::env(PYNQ_DEBUG_LED_MODE_OVERRIDE)] && $::env(PYNQ_DEBUG_LED_MODE_OVERRIDE) ne ""} {
    set debug_led_mode $::env(PYNQ_DEBUG_LED_MODE_OVERRIDE)
}
if {[info exists ::env(PYNQ_DEBUG_UART_DIAG_MODE_OVERRIDE)] && $::env(PYNQ_DEBUG_UART_DIAG_MODE_OVERRIDE) ne ""} {
    set debug_uart_diag_mode $::env(PYNQ_DEBUG_UART_DIAG_MODE_OVERRIDE)
}
...
puts "INFO: DEBUG_LED_MODE = ${debug_led_mode}"
puts "INFO: DEBUG_UART_DIAG_MODE = ${debug_uart_diag_mode}"
...
lappend synth_cmd -generic "DEBUG_LED_MODE=$debug_led_mode"
lappend synth_cmd -generic "DEBUG_UART_DIAG_MODE=$debug_uart_diag_mode"
if {$rom_init_hex ne ""} {
