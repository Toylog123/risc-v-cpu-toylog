...
@REM File role: scripts/run_m_extension_test.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/run_m_extension_test.bat
