...
@REM File role: scripts/prepare_riscv_tests.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/prepare_riscv_tests.bat
