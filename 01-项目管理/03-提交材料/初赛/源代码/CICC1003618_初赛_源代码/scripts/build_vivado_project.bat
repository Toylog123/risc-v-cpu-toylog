...
@REM File role: scripts/build_vivado_project.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/build_vivado_project.bat
