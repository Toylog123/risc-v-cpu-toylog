...
@REM File role: scripts/run_bitmanip_fast_subset_test.bat is part of the reproducible build, simulation or reporting script.
...
@REM File: scripts/run_bitmanip_fast_subset_test.bat
