...
本目录已迁入 `01-项目管理/05-汇报与提交材料/`，以便围绕比赛项目统一管理。
...
- `latex/main.tex`：初赛正式设计说明书 LaTeX 主入口，支持后续插图和 PDF 导出
- `YH_rv_cpu初赛设计说明书.pdf`：当前已本地编译出的提交版 PDF
...
- 赛题答疑整理：`../../01-赛题要求/七星微赛题答疑整理.md`
- 初赛设计说明书：`./latex/main.tex`
- 初赛设计说明书 PDF：`./YH_rv_cpu初赛设计说明书.pdf`
...
5. LaTeX 说明书中的结果必须和本目录索引、主文档和 fresh 证据保持一致。
